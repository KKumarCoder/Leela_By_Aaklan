  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        {/* TECHNICAL SPECS */}
        <div className="mt-16 md:mt-20 grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          {/* IMAGE */}
          <div
          ...
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-[#0F2348] mb-6">
              Technical Specifications
            </h3>

            <div className="overflow-x-auto rounded-xl border border-[#0F2348]/10">
              <table className="w-full">
                <thead>
                  <tr className="bg-gradient-to-r from-[#0F2348] to-[#1a3f5a] text-white">
                ...
                <tbody>
                  <tr className="border-b border-[#0F2348]/10 hover:bg-orange-100 transition-colors">
                    <td className="px-4 sm:px-6 py-4 font-semibold text-[#0F2348]">
                      Microcontroller
                    </td>
                    <td className="px-4 sm:px-6 py-4 text-[#0F2348]/70">
                  ...
                  <tr className="border-b border-[#0F2348]/10 hover:bg-orange-100 transition-colors">
                    ...
                    <td className="px-4 sm:px-6 py-4 text-[#0F2348]/70">
                      Ultrasonic, Infrared, Temperature, Humidity
                    </td>
                  </tr>
                  ...
                  <tr className="border-b border-[#0F2348]/10 hover:bg-orange-100 transition-colors">
                    ...
                    <td className="px-4 sm:px-6 py-4 text-[#0F2348]/70">
                      4x DC Motor Ports with PWM Control
                    </td>
                  </tr>
